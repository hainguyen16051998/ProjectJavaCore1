...
public class MenuAdmin implements IChooseFunction {
    ...
    public void showMenuManager(Scanner scanner, List<User> users, User user) {
        ...
        System.out.println("2. Chỉnh sửa tài khoản Staff");
        ...
        switch (ch) {
            ...
            case 2:
                ...
                break;
            case 3:
                viewChangeInfoAccount(scanner, users, user);
                break;
            case 4:
                removeAccount(scanner, users, user);
                break;
            case 0:
                showMenuManager(scanner, users, user);
        }
    ...
    public void viewChangeInfoAccount(Scanner scanner, List<User> users, User user) {
        while (true) {
            System.out.println("===================== Thay đổi thông tin Account =============================");
            System.out.println("1. Thay đổi username");
            System.out.println("2. Thay đổi mật khẩu");
            System.out.println("3. Thay đổi email");
            System.out.println("4. Thay đổi số điện thoại");
